...
- `power`: ngăn máy tự chuyển sang chế độ ngủ trong đúng thời gian người dùng chủ động chạy tìm kiếm hoặc quét lại. Màn hình vẫn có thể tắt/khóa; extension nhả yêu cầu giữ thức ngay khi lượt quét hoàn tất, bị hủy, gặp lỗi terminal hoặc được đưa về checkpoint chờ phục hồi.
